...
const TherapistRequests = ({ therapists, handleTherapistAccept, handleTherapistReject }) => {
    ...
    <div
      ...
      <div style={{ width: '90%', marginBottom:'5%',}}>
        ...
        <ul className="therapist-list">
          {
            list.length == 0 ?<p>No Pending Requests</p>: <p></p>
          }
          {list.map((therapist, index) => (
               ...
               <div style={{ display:'flex', maxWidth:'30%' }}>
                ...
                <Button  variant="contained" color="success"  
                  ...
                  onClick={() => handleTherapistAccept(therapist.email)}>Accept</Button>
                </div>
                <div style={{padding:"2%" }}>
                <Button  variant="outlined" color="error"
                  startIcon={<CancelIcon />} 
                  onClick={() => handleTherapistReject(therapist.email)}>Decline</Button>
                </div>
              </div>
             </li>
          ))}
